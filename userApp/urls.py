...
from .views import signup, signin, signout, view_profile, view_profile_topics, view_profile_replies, \
    ...
    send_message, create_channel, view_profile_admin, set_user_active, set_user_inactive, change_role
...
urlpatterns = [
    ...
    path('kullanici/rutbe-degistir', change_role, name='change_role'),
